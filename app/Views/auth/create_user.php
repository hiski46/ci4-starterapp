...
<div class="row">
      ...
      <div class="col-lg-2 col-md-6">
            <div class="form-floating mb-3">
                  <?php echo form_input($password_confirm, '', ['class' => 'form-control', 'placeholder' => 'password_confirm']); ?>
                  <?php echo form_label(lang('Auth.create_user_password_confirm_label'), 'password_confirm', ['for' => 'password_confirm']); ?>
            </div>
      </div>
</div>
<button type="submit" class="btn btn-primary"><?= icon('folder-plus') . ' ' . lang('Auth.create_user_submit_btn')    ?></button>
